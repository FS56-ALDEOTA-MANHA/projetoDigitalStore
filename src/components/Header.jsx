    ...
    <header className="bg-white shadow-sm">
      <div className="flex items-center gap-4 px-8 py-4">
        ...
        <div className="flex flex-1 items-center border border-[var(--light-gray-2)] rounded-sm overflow-hidden mx-4">
          <input type="text" value={busca} onChange={(e) => setBusca(e.target.value)} onKeyDown={handleKeyDown} placeholder="Pesquisar produto..." className="flex-1 px-4 py-2 outline-none text-[var(--dark-gray-2)] bg-transparent"/>
